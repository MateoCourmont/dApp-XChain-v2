            ...
            <button onClick={toggleDarkMode} className="cursor-pointer">
              {isDarkMode ? (
                <svg
                  ...
                  viewBox="0 0 24 24"
                  fill="currentColor"
                  class="size-5 fill-neutral-100 hover:fill-orange-400 transition-colors duration-300"
                >
                  <path
                    fill-rule="evenodd"
                ...
                <svg
                  ...
                  viewBox="0 0 24 24"
                  fill="currentColor"
                  class="size-5 fill-neutral-800 hover:fill-orange-400 transition-colors duration-300"
                >
